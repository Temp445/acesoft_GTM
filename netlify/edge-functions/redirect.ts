export default async (request: Request) => {
  ...
  const routePatterns = [
    ...
    {
      pattern: new RegExp(`^(\/${langPattern})?\/products\/ace-customer-relationship-management-system`),
      targetBase: 'https://acecrm-acesoft.netlify.app/'
    }
  ];
...
const generatePaths = () => {
  ...
  const basePaths = [
    ...
    '/products/ace-project-management-software/*',
    '/products/ace-customer-relationship-management-system',
    '/products/ace-customer-relationship-management-system/*',
  ];
