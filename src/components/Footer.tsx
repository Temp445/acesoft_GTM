...
const Footer = () => {
  ...
  return (
    <div className="bg-gray-900 text-white mt-10 lg:mt-0 py-8 lg:py-0 bottom-0">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col space-y-4  ">
              ...
              <div className="flex flex-col space-y-2 md:space-y-2">
                <a href="tel:+919840137210" className="text-xs md:text-sm xl:text-base flex gap-2">{t('links.phone')}: <br /><span className="text-gray-300 underline">+91 9840137210 </span> </a>
                <a href="mailto:sales@acesoft.in" className="text-xs md:text-sm xl:text-base flex gap-2">{t('links.email')}: <br /><span className="text-gray-300 underline">sales@acesoft.in </span> </a>
                <Link href="/demo/all-products" className="text-xs md:text-sm xl:text-base">{t('links.bookDemo')}</Link>
                <Link href="/privacy" className="text-xs md:text-sm xl:text-base">{t('links.privacy')}</Link>
                <Link href="/terms" className="text-xs md:text-sm xl:text-base">{t('links.terms')}</Link>
              </div>
            </div>
          </div>
