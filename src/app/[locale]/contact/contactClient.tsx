...
const contactClient: React.FC = () => {
  ...
  return (
    <div>
      <Commonbar />
      <Header />
      <div className="mt-0 px-2 md:pb-32">
        <div className="flex flex-col md:flex-row p-4 py-10 md:py-0 rounded-lg border md:border-0 max-w-7xl mx-auto mt-5 sm:mt-20 mb-20 justify-center ">
      ...
      {/* Contact Info */}
      <div className="flex flex-col lg:flex-row justify-center lg:justify-evenly lg:px-20 items-center gap-6 md:gap-5 lg:gap-5 lg:h-100 px-2 md:px-5 pb-20 lg:hidden">
